...
<div class="panel">
    <form action="<?php echo site_url('Subscriptions/payment');?>" method="POST" id="paymentFrm">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <input id="card_number" class="field">
            </div>
            <div class="row">
                <div class="left">
                    <div class="form-group">
                        <label>EXPIRY DATE</label>
                        <input id="card_expiry" class="field">
                    </div>
                </div>
                <div class="right">
                    <div class="form-group">
                        <label>CVC CODE</label>
                        <input id="card_cvc" class="field">
                    </div>
                </div>
            </div>
