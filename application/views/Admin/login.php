...
<form action="<?php echo base_url('AdminLogin/login')?>" method="post">
                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <div class="form-floating mb-3">
                            <input type="email" name="email" class="form-control" value="<?php echo set_value('email');?>" id="email" placeholder="name@example.com">
    ...
    <script src="<?php echo base_url('asset/js/moment-timezone.min.js');?>"></script>
    <script src="<?php echo base_url('asset/js/tempusdominus-bootstrap-4.min.js');?>"></script>
