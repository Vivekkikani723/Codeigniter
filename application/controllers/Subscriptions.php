...
class Subscriptions extends CI_Controller { 
    function __construct() { 
        ...
        // Load product model 
        $this->load->model('Subscriptions_model','model'); 
    ...
    public function index(){ 
        ...
        $this->load->view('user/subscriptions', $data); 
    } 
    ...
    function payment_status($id){ 
        ...
        $this->load->view('user/payment-status', $data); 
    } 
}